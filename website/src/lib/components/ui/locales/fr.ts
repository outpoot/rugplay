export default {
	...
	coin: {
		create: {
			...
			details: {
				...
				icon: {
					...
					description:
						"Cliquez pour télécharger l'icône de votre monnaie (PNG ou JPG, max 1MB)",
					err: [
						"Veuillez sélectionner un fichier image valide",
						"L'icône doit faire moins de 1MB",
					],
				},
				name: {
				...
				fairLaunchSettings: [
					...
					[
						"Verrouillage du Trading :",
						"Période de 1 minute réservée au créateur",
					],
		...
		trade: {
			...
			estimation:
				"Estimation AMM - inclut le glissement (slippage) dû à l'impact du pool",
			sell: {
				rec: "Vous recevrez :",
				title: "Vendre {{coin}}",
				amount: "Montant ({{coin}})",
	...
	gambling: {
		...
		live: {
			noData: {
				...
				description:
					"L'activité de jeu d'argent à enjeux élevés apparaîtra ici en temps réel.",
			},
	...
	leaderboard: {
		...
		biggestLosses: {
			description:
				"Utilisateurs ayant subi les plus grosses pertes aujourd'hui",
			loss: "Perte",
		...
		highestPortfolio: {
			description:
				"Utilisateurs avec les soldes de trésorerie liquide les plus élevés",
	...
	prestige: {
		title: "Prestige",
		description:
			"Réinitialisez votre progression pour améliorer votre statut de trading",
		how: [
			"Comment",
			[
	...
	treemap: {
		...
		noCoins: {
			description:
				"Créez quelques monnaies pour voir la visualisation du treemap.",
		},
	...
	transactions: {
		title: "Transactions",
		description:
			"Enregistrement complet de votre activité de trading et de vos transactions",
		input: {
		...
		history: {
			title: "Historique",
			description:
				"Enregistrement complet de votre activité de trading et de vos transferts",
		},
		empty: {
