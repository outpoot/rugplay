export default {
	...
	hopium: {
		...
		minBalance: 'Você precisa de pelo menos $100.000 em seu portfólio (dinheiro) para criar uma pergunta.',
		no: 'NÃO',
		noQuestions: {
	...
	market: {
		'24hChange': {
			...
			values: ['Todas as mudanças', 'Apenas ganhadores', 'Apenas perdedores', 'Quentes (±10%)', 'Hild (±50%)']
		},
		apply: 'Aplicar',
		...
		input: {
			...
			noMatch: 'Nenhuma moeda corresponde à sua pesquisa "{{query}}". Tente palavras-chave diferentes ou ajuste os filtros.',
