...
export const user = pgTable(
	'user',
	{
		...
		bio: varchar('bio', { length: 160 }).default(
			'Hello am 48 year old man from somalia. Sorry for my bed england. I selled my wife for internet connection for play “conter stirk”'
		),
...
export const predictionQuestion = pgTable(
	'prediction_question',
	{
		...
		totalYesAmount: decimal('total_yes_amount', { precision: 20, scale: 8 })
			.notNull()
			.default('0.00000000'),
		totalNoAmount: decimal('total_no_amount', { precision: 20, scale: 8 })
			.notNull()
			.default('0.00000000'),
