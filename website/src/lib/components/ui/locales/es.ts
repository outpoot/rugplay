export default {
	...
	coin: {
		create: {
			...
			details: {
				...
				icon: {
					...
					description:
						"Haz clic para subir el ícono de tu moneda (PNG o JPG, máx. 1MB)",
					err: [
		...
		trade: {
			...
			estimation:
				"Estimación AMM - incluye deslizamiento (slippage) por impacto del pool",
			sell: {
				rec: "Recibirás:",
				title: "Vender {{coin}}",
	...
	gambling: {
		...
		signin: {
			...
			description:
				"Necesitas una cuenta para apostar tus ahorros de toda la vida ",
		},
		games: {
			coinflip: {
			...
			mines: {
				title: "Minas",
				description:
					"¡Navega por el campo minado y cobra antes de pisar una mina!",
		...
		live: {
			noData: {
				...
				description:
					"La actividad de apuestas de alto riesgo aparecerá aquí en tiempo real.",
			},
	...
	hopium: {
		...
		minBalance:
			"Necesitas al menos $100,000 en tu portafolio (efectivo) para crear una pregunta.",
		no: "NO",
		noQuestions: {
	...
	leaderboard: {
		...
		topRugpullers: {
			description:
				"Usuarios que obtuvieron la mayor ganancia vendiendo monedas hoy",
	...
	market: {
		...
		apply: "Aplicar",
		description:
			"Descubre monedas, sigue el rendimiento y encuentra tu próxima inversión",
		input: {
			filters: {
	...
	portfolio: {
		...
		title: "Portafolio",
		err: [
			"Fallo al cargar los datos del portafolio",
			"Fallo al cargar las transacciones",
		],
		holdings: {
			title: "Tus activos",
	...
	prestige: {
		...
		how: [
			...
			[
				"Cumplir Requisitos",
				"Acumula suficiente efectivo para pagar el costo de prestigio",
			],
			[
		...
		progress: {
			...
			button: [
				"Necesitas {{bal}} más para prestigio",
				"¡Vamos!",
				"Avanzando a {{name}}",
			],
			star: [
				"¡Eres una estrella!",
				"Has alcanzado el nivel de prestigio más alto disponible.",
			],
	...
	treemap: {
		...
		noCoins: {
			description:
				"Crea algunas monedas para ver la visualización del treemap.",
		},
	...
	transactions: {
		...
		history: {
			title: "Historial",
			description:
				"Registro completo de tu actividad de trading y transferencias",
		},
		empty: {
	...
	promocode: {
		...
		description:
			"Ingresa tu código promocional a continuación para canjear recompensas y bonos.",
