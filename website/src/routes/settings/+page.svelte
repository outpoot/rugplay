		...
		<Card.Root class="gap-1 mx-auto max-w-4xl p-6">
			<Card.Content>
				<div class="py-12 text-center">
					...
					>
						<HugeiconsIcon icon={GearsIcon} class="text-muted-foreground h-8 w-8" />
					</div>

					<h3 class="mb-2 text-lg font-semibold">Please sign in</h3>
					<p class="mb-6 text-muted-foreground">You need to be logged in to view your settings</p>
