export default {
		...
		create: {
			...
			details: {
				...
				icon: {
					...
					description:
						"Clique para carregar o ícone da sua moeda (PNG ou JPG, máx 1MB)",
					err: [
						"Selecione um arquivo de imagem válido",
						"O ícone deve ter menos de 1MB",
					],
				},
				name: {
					title: "Nome da Moeda",
				...
				fairLaunchSettings: [
					...
					[
						...
						"Período de 1 minuto exclusivo para o criador",
					],
	...
	gambling: {
		...
		games: {
			...
			mines: {
				title: "Minas",
				description:
					"Navegue pelo campo minado e saqueie antes de atingir uma mina!",
		...
		live: {
			noData: {
				...
				description:
					"Atividade de jogos de azar de alto risco aparecerá aqui em tempo real.",
			},
	...
	hopium: {
		...
		description:
			"Mercados de previsão alimentados por IA. Crie perguntas e aposte em resultados.",
	...
	market: {
		...
		apply: "Aplicar",
		description:
			"Descubra moedas, acompanhe o desempenho e encontre seu próximo investimento",
		input: {
			filters: {
	...
	prestige: {
		title: "Prestígio",
		description:
			"Reinicie seu progresso para melhorar seu status de negociação",
		how: [
			"Como",
			[
				"Atenda aos Requisitos",
				"Acumule dinheiro suficiente para pagar o custo do prestígio",
			],
			[
				"Redefinir Progresso",
				"Todo o dinheiro e ativos são apagados, mas o histórico permanece",
			],
			[
				"Ganhe Status",
		...
		progress: {
			...
			letsGo: "Vamos lá",
			button: [
				"Precisa de mais {{bal}} para prestigiar",
				"Vamos lá",
				"Avançando para {{name}}",
			],
			star: [
				"Você é uma estrela!",
				"Você alcançou o maior nível de prestígio disponível.",
			],
		...
		preview: {
			...
			after: "Depois",
			description:
				"Você também ganha {{percent}}% a mais em recompensas diárias.",
		},
		levels: {
			title: "Níveis",
			d: {
	...
	transactions: {
		title: "Transações",
		description:
			"Registro completo de sua atividade de negociação e transações",
		input: {
		...
		history: {
			title: "Histórico",
			description:
				"Registro completo de sua atividade de negociação e transferências",
		},
		empty: {
	...
	promocode: {
		...
		description:
			"Insira seu código promocional abaixo para resgatar recompensas e bônus.",
